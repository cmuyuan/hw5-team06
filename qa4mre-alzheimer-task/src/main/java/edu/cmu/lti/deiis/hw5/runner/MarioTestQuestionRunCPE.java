 ...
 * 
 */
public class MarioTestQuestionRunCPE extends Thread {
  /**
   * The CPE instance.
   */
   ...
   */
  public MarioTestQuestionRunCPE(String args[]) throws Exception {
    mStartTime = System.currentTimeMillis();
    if(args.length==0){
    	args=new String[1];
    	args[0]=new String("src/main/resources/MarioCpeQuestionDescriptor.xml");
    }
  ...
  public static void main(String[] args) throws Exception {
    new MarioTestQuestionRunCPE(args);
  }
